      ...
      <div className="!ml-[4px] !flex !flex-col !items-start !gap-2">
        ...
        <div className='!flex !gap-2  !flex-col !items-start '>
          ...
          <input
            ...
            className='!w-[385px] !h-[45px] !text-xl outline-0  !pb-1 !pl-4 !font-medium  !border-[#DADADA] !border-2 !rounded' type='email' required />
          ...
          <input
            ...
            className='!w-[385px] outline-0 !h-[45px] !text-xl !pb-1 !pl-4 !font-medium  !border-[#DADADA] !border-2 !rounded' type='password' required />
