...
exports.isValidTimeSlot = exports.generateTimeSlots = void 0;
// Generate time slots (e.g., 9:00 AM to 5:00 PM, 30-minute intervals)
const generateTimeSlots = () => {
    const slots = []; // Initialize empty array to store time slots
...
const isValidTimeSlot = (timeString) => {
    const validSlots = (0, exports.generateTimeSlots)(); // Get array of all valid time slots
